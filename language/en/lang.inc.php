...
'box_desc' => "Below is a list of all the current boxes in the database.",
...
'no_box_exist' => "No box exist for category in the database.",
...
'add_month_desc' => "You can use the form below to add Product of month.",
...
'overview_lang' => "(In primary language other languages can be added afterwards.)",

'feature_lang' => "(In primary language other languages can be added afterwards.)",
...
'welcome_note' => "Welcome to the Appliances Centre Administration Control Panel",
...
'admin_email_body_1' => "Dear Jag Direct Administrator,
...
'session_destroyed' => "Your session has been ended.",
...
'desc' => "The total weight of your order it too high. Please contact us to see if we can make an alternative arrangement or reduce the amount of items in your Cart.",
...
'special_note'	=>	"Please note that all fields that have an asterisk (*) are required.",
...
'error_name' => "Please enter your name and your friend name.",

'error_email' => "Please make sure your email address and your friend email address is valid.",
...
%s/index.php?act=viewProd&productId=%s&customer_id=%s
~~~~~~~~~~~~~~~~~~~~~~~~~~
...
'latest_products' => "Lastest Products",
...
'no_orders' => "We have no records of any orders placed in our system. If you feel this is an error please contact a member of staff at the first possible opportunity.",
...
'prod_not_found' => "Product could not be found. Please Click Home Button",
...
'if_changed_quan' => "(if you have changed any quantities or change delivery days.)",
...
'try_again_desc' => "You can attempt to purchase your Cart contents again below:",
