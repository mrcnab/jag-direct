...
<table width="100%" cellpadding="3" cellspacing="0" border="0">
	...
	<tr align="left">
		<td colspan="4"><br />{VAL_AVSMSG}<br /><br /></td>
	</tr>			
	<tr align="left">
		<td><strong>E-Mail: </strong>
	  <td colspan="3">{VAL_EMAIL_ADDRESS}<input type="hidden" name="emailAddress" value="{VAL_EMAIL_ADDRESS}" size="50" class="textbox" /></td>
	</tr>
	<tr align="left">
		<td><strong>Address: </strong>
	  <td colspan="3">{VAL_ADD_1}<input type="hidden" name="addr1" value="{VAL_ADD_1}" size="50" class="textbox" /></td>
	</tr>
	<tr align="left">
		<td><strong>Address 2: </strong>
	  <td colspan="3">{VAL_ADD_2}<input type="hidden" name="addr2" value="{VAL_ADD_2}" size="50" class="textbox" /></td>
	</tr>
	<tr align="left">
		<td>
		<strong>City:</strong> 
		</td>
		<td colspan="3">{VAL_CITY}
		<input type="hidden" name="city" value="{VAL_CITY}" class="textbox" />
	  </td>
  </tr>
		<tr align="left">
		<td>
		...
		<td colspan="3">{VAL_COUNTY}
		<input type="hidden" name="state" value="{VAL_COUNTY}" size="2" class="textbox" />
		</td>
		</tr>
		<tr align="left">
		<td>
		...
		<td colspan="3">{VAL_POST_CODE}
		<input type="hidden" name="postalCode" value="{VAL_POST_CODE}" size="10" maxlength="10" class="textbox" />
	  </td>
	</tr>
		<tr align="left">
		<td>
		...
		<td colspan="3">{VAL_PHONE}
		<input type="hidden" name="phoneNumber" value="{VAL_PHONE}" size="10" maxlength="15" class="textbox" />
	  </td>
	</tr>
	<tr align="left">
		<td><strong>Country: </strong>
		<td colspan="3">{VAL_COUNTRY_ISO} {VAL_COUNTRY_NAME}
