...
|	transfer.php
|   ========================================
|	Core functions for the Verisign Gateway	
+--------------------------------------------------------------------------
*/
/*
//////////////////////////
...
function fixedVars(){
	...
	$hiddenVars = "<input type='hidden' name='LOGIN' value='".$module['acNo']."' />
				<input type='hidden' name='PARTNER' value='".$module['partner']."' />
				<input type='hidden' name='AMOUNT' value='".$basket['grandTotal']."' />
				<input type='hidden' name='TYPE' value='S' />
				<input type='hidden' name='DESCRIPTION' value='".$cart_order_id."' />
				<input type='hidden' name='NAME' value='".$ccUserData[0]['firstName']." ".$ccUserData[0]['lastName']."' />
				<input type='hidden' name='ADDRESS' value='".$ccUserData[0]['add_1']." ".$ccUserData[0]['add_2']."' />
...
function success(){
	...
	if($_POST['RESPMSG']=="Approved" || $_GET['RESPMSG']=="Approved") {
