...
<title><?php echo $lang['install']['installHelp']; ?> <?php echo $lang['install']['helpDatabase']; ?></title>
...
<div style="font-size: 16px; color: #0971CE; font-weight: bold; padding-top: 5px; padding-bottom: 5px;"><?php echo $lang['install']['mysqlDBSettings']; ?></div>
<?php echo $lang['install']['mysqlDBSettingsDesc']; ?>
</body>
</html>