...
<title><?php echo $lang['install']['installHelp']; ?> <?php echo $lang['install']['helpAdminSettings']; ?></title>
...
<div style="font-size: 16px; color: #0971CE; font-weight: bold; padding-top: 5px; padding-bottom: 5px;"><strong><?php echo $lang['install']['adminConfSettings']; ?></strong></div>
<?php echo $lang['install']['adminConfSettingsDesc']; ?>
</body>
</html>