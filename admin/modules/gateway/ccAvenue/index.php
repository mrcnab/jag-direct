...
$module = fetchDbConfig($_GET['folder']);
?>
<p><a href="http://www.ccavenue.com/"><img src="logo.gif" alt="" border="0" title="" /></a></p>
<?php 
if(isset($msg)){ 
	echo stripslashes($msg); 
} 
?>
<p class="copyText">&quot;eTransactions&quot;</p>
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="tdText"><input type="text" name="module[desc]" value="<?php echo $module['desc']; ?>" class="textbox" size="30" /></td>
     ...
     <tr>
  	<td align="left" class="tdText"><strong>Working Key:</strong> (To be created in your ccAvenue control panel)
	</td>
    <td class="tdText"><input type="text" name="module[WorkingKey]" value="<?php echo $module['WorkingKey']; ?>" class="textbox" size="30" /></td>
  </tr>
  <tr>
  <td align="left" class="tdText"><strong>Merchant Id:</strong></td>
    ...
    <tr>
  <td align="left" class="tdText"><strong>Gateway:</strong></td>
      <td class="tdText">
	<select name="module[gate]">
		<option value="US" <?php if($module['gate'] == "US") echo "selected='selected'"; ?>>American Gateway</option>
		<option value="IN" <?php if($module['gate'] == "IN") echo "selected='selected'"; ?>>Indian Gateway</option>
	</select>
	</td>
  </tr>
  <tr>
