...
<p><a href="http://www.mals-e.com"><img src="logo.gif" alt="" border="0" title="" /></a></p>
<?php 
if(isset($msg)){ 
	echo stripslashes($msg); 
} 
?>
<p class="copyText">&quot;Configure the cart to collect card data and save it for processing later or link directly to a number of big name payment processors.&quot;</p>
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <td align="left" class="tdText"><strong>Account Number:</strong></td>
    <td class="tdText"><input type="text" name="module[acc]" value="<?php echo $module['acc']; ?>" class="textbox" size="30" /></td>
  </tr>
  <tr>
  <td align="left" class="tdText"><strong>Server Domain:</strong><br/>e.g. wwX.aitsafe.com</td>
    <td class="tdText"><input type="text" name="module[domain]" value="<?php echo $module['domain']; ?>" class="textbox" size="30" /></td>
  </tr>
    <tr>
