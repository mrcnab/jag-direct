...
$module = fetchDbConfig($_GET['folder']);
?>
<p><a href="http://www.verisign.com/"><img src="logo.gif" alt="" border="0" title="" /></a></p>
<?php 
if(isset($msg)){ 
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <td align="left" class="tdText"><strong>Merchant Id:</strong></td>
    ...
    <tr>
  <td align="left" class="tdText"><strong>Partner:</strong></td>
    <td class="tdText"><input type="text" name="module[partner]" value="<?php echo $module['partner']; ?>" class="textbox" size="30" /></td>
  </tr>
      <tr>
  <td align="left" class="tdText"><strong>Country:</strong></td>
    <td class="tdText">
	<select name="module[url]">
	<option value="https://payments.verisign.com.au/payflowlink" <?php if($module['url']=="https://payments.verisign.com.au/payflowlink") echo "selected='selected'"; ?>>Australia</option>
	<option value="https://payments.verisign.com/payflowlink" <?php if($module['url']=="https://payments.verisign.com/payflowlink") echo "selected='selected'"; ?>>USA</option>
	</select>
	</td>
  </tr>
