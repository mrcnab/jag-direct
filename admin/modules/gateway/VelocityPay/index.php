  ...
  <tr>
    ...
    <td class="tdText">
        <!-- Select Code --->
            ...
            <option value=638<? if ($module['VPCurrencyCode']==638) { echo " selected"; } ?>>FRF (Réunion)</option>
            ...
            <option value=678<? if ($module['VPCurrencyCode']==678) { echo " selected"; } ?>>STD (São Tomé and Príncipe Democratic)</option>
            ...
            <option value=384<? if ($module['VPCurrencyCode']==384) { echo " selected"; } ?>>XAF (Côte d'Ivoire)</option>
