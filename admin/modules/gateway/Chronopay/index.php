...
$module = fetchDbConfig($_GET['folder']);
?>
<p><a href="http://www.chronopay.com/"><img src="logo.gif" alt="" border="0" title="" /></a></p>
<?php 
if(isset($msg)){ 
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <tr>
   <td align="left" class="tdText"><strong>Response URL:</strong><br/>This has to be set in the Chronopay Product <br/>in the Chronopay control panel.</td>
      <td class="tdText">
	<input type="textbox" name="relayUrl" size="40" value="<?php echo $GLOBALS['storeURL']."/modules/gateway/Chronopay/confirmed.php";?>" />
	</td>
  </tr>  
  <tr>
