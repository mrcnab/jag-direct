...
if (isset($_POST['email'])){
	...
	if($result == TRUE) {
		...
		$mail->setFrom('Swanky Mailer <'.$config['masterEmail'].'>');
		$mail->setSubject('Swanky Admin Password');
		$mail->setHeader('X-Mailer', 'Swanky Mailer');
...
<div style="margin: auto; width: 238px; padding-bottom: 10px;"><a href="index.php"><img src="<?php echo $GLOBALS['rootRel']; ?>admin/images/tws-logo.jpg" alt="" width="238" height="61" border="0" title="" /></a></div>
...
<div style="margin: auto; width: 224px; padding-top: 10px; text-align: right;" class="copyText">Copyright <a href="http://www.titlewebsolutions.com" target="_blank" class="txtLink">Titlewebsolutions</a> 2009.<br />All rights reserved.</div>
