...
$profile = new XTemplate ("skins/".$config['skinDir']."/styleTemplates/content/profile.tpl");
	...
	if($ccUserData[0]['customer_id']>0) { 
		...
		$profile->assign("TXT_ADD_2",$lang['front']['profile']['address2']);
	...
	for($i=0; $i<count($countries); $i++){
		...
		$profile->assign("TXT_COMMENTS",$lang['front']['profile']['comments']);
		$profile->assign("VAL_COMMENTS",$ccUserData[0]['comments']);
