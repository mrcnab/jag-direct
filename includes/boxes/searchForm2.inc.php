...
$box_content = new XTemplate ("skins/".$config['skinDir']."/styleTemplates/boxes/searchForm2.tpl");
...
$box_content->parse("search_form2");
$box_content = $box_content->text("search_form2");
?>