...
<body>
	<div id="pageSurround">
		<div style="padding: 5px;">
			<div id="divThumbsImg">
				<!-- BEGIN: thumbs -->
				<div style="padding: 5px;"><a href="javascript:getImage('{VALUE_SRC}');"><img src="{VALUE_THUMB_SRC}" alt="{ALT_THUMB}" width="{VALUE_THUMB_WIDTH}" border="0" class="thumbsImg" title="{ALT_THUMB}" /></a></div>
				<!-- END: thumbs -->
			</div>
