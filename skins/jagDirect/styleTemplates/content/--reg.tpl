<!-- BEGIN: reg -->
<div class="pro-wrap">
<div class="feature-heading"><b>{LANG_REGISTER}</b></div>
	...
	<br />
    <table border="0" cellspacing="2" cellpadding="0" width="100%" style="position:relative;right:2px;">
	  <tr>
		<td colspan="2"><b>{LANG_PERSONAL_DETAILS}</b></td>
	  </tr>
	  <tr>
	    <td width="45%" valign="top">{LANG_TITLE}</td>
	  ...
	  <tr>
		...
		<td><input name="password" type="password" class="txtfield" id="password" size="16" value="{VAL_PASSWORD}" tabindex="13" /><font color="red">  *</font></td>
	  </tr>
	  <tr>
		<td>{LANG_CONFIRM_PASSWORD}</td>
		<td><input name="passwordConf" type="password" class="txtfield" id="passwordConf" size="16" value="{VAL_PASSWORD_CONF}" tabindex="14" /><font color="red">  *</font></td>
	  </tr>
      <tr>
		<td colspan="2">&nbsp;</td>
	</tr>
	  ...
	  <tr>
	    ...
	    <td><input name="add_1" type="text" class="txtfield" id="add_1" size="16" value="{VAL_ADD_1}" tabindex="7" /><font color="red">  *</font></td>
	    </tr>
	  <tr>
		<td>&nbsp;</td>
		<td><input name="add_2" type="text" class="txtfield" id="add_2" size="16" value="{VAL_ADD_2}" tabindex="8" /></td>
	  </tr>
	  <tr>
		<td>{LANG_TOWN}</td>
		<td><input name="town" type="text" class="txtfield" id="town" size="16" value="{VAL_TOWN}" tabindex="9" /><font color="red">  *</font></td>
	  </tr>
	  <tr>		
		<td>{LANG_COUNTY}</td>
		<td><input name="county" type="text" class="txtfield" id="county" size="16" value="{VAL_COUNTY}" tabindex="10" /><font color="red">  *</font></td>
	  </tr>
	  <tr>
		<td>{LANG_COUNTRY}</td>
	    <td nowrap='nowrap'><select name="country" class="txtfield_combo" tabindex="11">
	  ...
	  <tr>
		<td>{LANG_POSTCODE}</td>
	    <td><input name="postcode" type="text" class="txtfield" id="postcode" size="16" value="{VAL_POSTCODE}" tabindex="12" /><font color="red">  *</font></td>
	  </tr>
      <tr>
		<td colspan="2">&nbsp;</td>
		</tr>
      ...
      <tr>
		...
		<td>
            <select name="htmlEmail" class="txtfield_combo" tabindex="16">
        ...
        <tr>
        <td>&nbsp;</td>
            <td valign="top"><input type="checkbox" name="optIn1st" value="1" tabindex="15" {VAL_OPTIN1ST_CHECKED}/> {LANG_RECIEVE_EMAILS}<br /> {LANG_PLEASE_READ} {LANG_TANDCS}.</td>
        </tr>
        <tr>
        <td colspan="2">&nbsp;</td>
        </tr>
