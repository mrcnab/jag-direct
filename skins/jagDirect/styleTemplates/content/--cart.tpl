<!-- BEGIN: view_cart -->
<div class="pro-wrap">
<div class="feature-heading"><b>{LANG_VIEW_CART}</b></div>

 <div style="float:left; padding:5px; ">
			 <form action="{VAL_FORM_ACTION}" method="post" cclass="quickBuy" style="padding: 4px; padding-left:10px; margin-bottom:10px; text-align:left;">
                  {LANG_ADD_PRODCODE}
                  <input name="productCode" type="text" class="txtfield_cart" /> 
                  <input name="submit" type="submit" class="btn_cart" value="{LANG_ADD}" />
              </form>
			  <!-- BEGIN: cart_false -->
 ...
 <tr class="secondary-row">
            ...
            <table width="98%" border="0" cellspacing="2" cellpadding="2" align="center">
              ...
              <tr class="secondary-row">
                    ...
                    <td align="center"   width="700"><div style="text-align:left; padding:2px;">{VAL_PRODUCT_NAME}</div>
                        <!-- BEGIN: options -->
              ...
              <tr class="secondary-row">
				  ...
				  <td width="40" align="center">{VAL_SHIPPING}</td>
			  </tr>
              <tr class="secondary-row">
              ...
              <tr style="height:50px;" align="right">
                  <td align="right" colspan="8">{LANG_UPDATE_CART_DESC} <a href="javascript:submitDoc('cart');" class="btn" >{LANG_UPDATE_CART}</a> <a href="{CONT_VAL}" class="btn">{LANG_CHECKOUT}</a> </td>
              </tr>
            </table>
