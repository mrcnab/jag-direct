                ...
                <div id="my_menu{DATA1.box_id}" class="left-nav">
                      ...
                      <!-- BEGIN: main_div -->
                       <div>
                     	...
                     	<!-- BEGIN: category -->
                        <span><a href="index.php?act=viewCat&amp;catId={VAL_CAT_ID}">{DATA.cat_name}</a> </span>
                       <!-- END: category -->                                             
                       
                       	<!-- BEGIN: category_false -->
                        <span class="remove-arrow"><a onclick="window.location='index.php?act=viewCat&amp;catId={VAL_CAT_ID}'">{DATA.cat_name}</a> </span>
                        <!-- END: category_false -->
